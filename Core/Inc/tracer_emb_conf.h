...
#define TRACER_EMB_USART_IRQ                         USART2_LPUART2_IRQn
#define TRACER_EMB_USART_IRQHANDLER                  USART2_LPUART2_IRQHandler
...
#define TRACER_EMB_TX_DMA_REQUEST                    LL_DMAMUX_REQ_USART2_TX
